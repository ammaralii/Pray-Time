...
import com.ammarali.ramadanalarm.fragments.InitialConfigFragment;
import com.ammarali.ramadanalarm.fragments.KaabaLocatorFragment;
import com.ammarali.ramadanalarm.fragments.LocationHelper;
import com.ammarali.ramadanalarm.fragments.SalaatTimesFragment;
import com.ammarali.ramadanalarm.util.AppSettings;
import com.ammarali.ramadanalarm.util.PermissionUtil;
import com.ammarali.ramadanalarm.util.ScreenUtils;
import com.ammarali.ramadanalarm.widget.FragmentStatePagerAdapter;
import com.ammarali.ramadanalarm.widget.SlidingTabLayout;
    ...
    LocationHelper.LocationCallback
{
  ...
  private ViewPager mPager;//Layout manager that allows the user to flip left and right through pages of data
  private ScreenSlidePagerAdapter mAdapter;//This is the adaptor class I create locally
  private SlidingTabLayout mTabs;//Widget class
